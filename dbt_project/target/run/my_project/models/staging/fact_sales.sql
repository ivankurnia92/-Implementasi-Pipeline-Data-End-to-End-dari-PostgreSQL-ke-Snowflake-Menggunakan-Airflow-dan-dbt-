        ...
        create or replace transient table DBT_DEV_DB.PUBLIC_2_STAGING.fact_sales
         as
        (

with orders as (
    select * from "DBT_DEV_DB"."PUBLIC_1_RAW"."ORDERS"
),

order_details as (
    select * from "DBT_DEV_DB"."PUBLIC_1_RAW"."ORDER_DETAILS"
),
